...
use Admin0902\Models\Textopublico;
use Foundation\Controller;

class TextopublicoController extends Controller {

    protected $textopublico;

    public function __construct() {
        $this->textopublico = new Textopublico();
    }

    public function index() {
        $dados_textopublico = $this->textopublico->getTextopublicoAll();
        return $this->render('textopublico/index', [
    ...
    public function imagens() {
        ...
        return $this->render('tratamentos/imagens', [
    ...
    public function cadastrar() {
        ...
        return $this->render('textopublico/cadastrar', [
                    'dados_textopublico' => $dados_textopublico
        ]);
    }
    ...
    public function salvar() {
        ...
        if ($idTextopublico) {
            ...
            return redirect()->route('textopublico.index');
        }
