...
use Admin0902\Models\Textoprofissionais;
use Foundation\Controller;

class TextoprofissionaisController extends Controller {

    protected $textopublico;

    public function __construct() {
        $this->textopublico = new Textoprofissionais();
    }

    public function index() {
        $dados_textopublico = $this->textopublico->getTextopublicoAll();
        return $this->render('textoprofissionais/index', [
    ...
    public function imagens() {
        ...
        return $this->render('textoprofissionais/imagens', [
    ...
    public function cadastrar() {
        ...
        return $this->render('textoprofissionais/cadastrar', [
                    'dados_textopublico' => $dados_textopublico
        ]);
    }
    ...
    public function salvar() {
        ...
        if ($idTextopublico) {
            ...
            return redirect()->route('textoprofissionais.index');
        }
    ...
    public function fileupload() {
        return $this->render('tratamentos/fileupload');
    }
